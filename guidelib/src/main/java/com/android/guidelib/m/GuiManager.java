...
import com.android.guidelib.m.model.impl.Tempo;
...
public  class GuiManager {
   ...
   private static GuiManager g;
    ...
    public IGuiDelivery getGui(String  SimplName){
        ...
        if (guiRecord.commitVersion != guiModel.getVersion()) return guiModel;
        return null;
    }
   public void commit(String simplName){
       GuiModel guiModel = map.get(simplName);
       if (guiModel == null)return;
       GuiCache.gkv().putString(simplName,mGson.toJson(new GuiRecord(guiModel.commitVersion)));
   }
